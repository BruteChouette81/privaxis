      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
            { window.localStorage.getItem("hasWallet") ?  window.localStorage.getItem("language") == "fr" ?  <div><button onClick={() => {window.location.replace("/seller/0")}} class="btn btn-outline-success me-2" style={{ float:"left", paddingLeft: 20 + "px", paddingRight: 20 + "px"}}>connexion partenaire</button> </div> :  <div><button onClick={() => {window.location.replace("/seller/0")}} class="btn btn-outline-success me-2" style={{ float:"left", paddingLeft: 20 + "px", paddingRight: 20 + "px"}}>Partner login</button> </div> : window.localStorage.getItem("language") == "fr" ? <div><button onClick={() => {window.location.replace("/seller/0")}} class="btn btn-outline-success me-2" style={{ float:"left", paddingLeft: 20 + "px", paddingRight: 20 + "px"}}>Devenir un partenaire</button> </div> : <div><button onClick={() => {window.location.replace("/seller/0")}} class="btn btn-outline-success me-2" style={{ float:"left", paddingLeft: 20 + "px", paddingRight: 20 + "px"}}>Partner sign up</button> </div>}
            </li>
